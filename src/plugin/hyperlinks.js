...
Worker.prototype.toContainer = function toContainer() {
  return orig.toContainer.call(this).then(function toContainer_hyperlink() {
    ...
    if (this.opt.enableLinks) {
      ...
      var pxPageHeight = Math.floor(containerWidth * this.prop.pageSize.inner.ratio);
      var links = container.querySelectorAll('a');
      var containerRect = unitConvert(container.getBoundingClientRect(), this.prop.pageSize.inner.height, pxPageHeight);
      linkInfo = [];
      ...
      Array.prototype.forEach.call(links, function(link) {
        ...
        for (var i=0; i<clientRects.length; i++) {
          var clientRect = unitConvert(clientRects[i], this.prop.pageSize.inner.height, pxPageHeight);
